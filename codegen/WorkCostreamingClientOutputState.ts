...
export interface IWorkCostreamingClientOutputStateArgs {
    liveStreamingStatus?: number;
    stageInfo?: StageInfo.StageInfo;
}
export class WorkCostreamingClientOutputState {
    public liveStreamingStatus?: number;
    public stageInfo?: StageInfo.StageInfo;
    constructor(args?: IWorkCostreamingClientOutputStateArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("WorkCostreamingClientOutputState");
    ...
    public static read(input: thrift.TProtocol): WorkCostreamingClientOutputState {
        ...
        input.readStructEnd();
        return new WorkCostreamingClientOutputState(_args);
    }
}
