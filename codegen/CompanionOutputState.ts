...
export interface ICompanionOutputStateArgs {
...
export class CompanionOutputState {
    ...
    public self?: CompanionEndpoint.CompanionEndpoint;
    constructor(args?: ICompanionOutputStateArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("CompanionOutputState");
        ...
        if (this.self != null) {
            output.writeFieldBegin("self", thrift.Thrift.Type.STRUCT, 3);
    ...
    public static read(input: thrift.TProtocol): CompanionOutputState {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_9: CompanionEndpoint.CompanionEndpoint = CompanionEndpoint.CompanionEndpoint.read(input);
                        _args.self = value_9;
                    }
                    else {
                        input.skip(fieldType);
        ...
        input.readStructEnd();
        return new CompanionOutputState(_args);
    }
}
