...
export interface INackPayloadArgs {
...
export class NackPayload {
    ...
    constructor(args?: INackPayloadArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("NackPayload");
    ...
    public static read(input: thrift.TProtocol): NackPayload {
