...
export interface IRtcMessageBodyVariantArgs {
...
export class RtcMessageBodyVariant {
    ...
    constructor(args?: IRtcMessageBodyVariantArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("RtcMessageBodyVariant");
    ...
    public static read(input: thrift.TProtocol): RtcMessageBodyVariant {
        ...
        input.readStructEnd();
        return new RtcMessageBodyVariant(_args);
    }
}
