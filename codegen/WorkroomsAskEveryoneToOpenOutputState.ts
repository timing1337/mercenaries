...
export interface IWorkroomsAskEveryoneToOpenOutputStateArgs {
...
export class WorkroomsAskEveryoneToOpenOutputState {
    ...
    constructor(args?: IWorkroomsAskEveryoneToOpenOutputStateArgs) {
        ...
        if (args != null && args.timestamp_utc != null) {
            this.timestamp_utc = args.timestamp_utc;
        }
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("WorkroomsAskEveryoneToOpenOutputState");
        ...
        if (this.timestamp_utc != null) {
            output.writeFieldBegin("timestamp_utc", thrift.Thrift.Type.STRING, 4);
            output.writeString(this.timestamp_utc);
            output.writeFieldEnd();
        }
        if (this.type != null) {
        ...
        if (this.intent != null) {
            output.writeFieldBegin("intent", thrift.Thrift.Type.I32, 6);
            output.writeI32(this.intent);
            output.writeFieldEnd();
        }
        if (this.resource != null) {
            output.writeFieldBegin("resource", thrift.Thrift.Type.STRUCT, 7);
    ...
    public static read(input: thrift.TProtocol): WorkroomsAskEveryoneToOpenOutputState {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 7:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_7: WorkroomsResource.WorkroomsResource = WorkroomsResource.WorkroomsResource.read(input);
                        _args.resource = value_7;
                    }
                    else {
                        input.skip(fieldType);
                    }
        ...
        input.readStructEnd();
        return new WorkroomsAskEveryoneToOpenOutputState(_args);
    }
}
