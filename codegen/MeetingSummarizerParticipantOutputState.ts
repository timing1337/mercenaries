...
export interface IMeetingSummarizerParticipantOutputStateArgs {
    enabled?: boolean;
    dataChannelNodeId?: number | Int64;
}
export class MeetingSummarizerParticipantOutputState {
    public enabled?: boolean;
    public dataChannelNodeId?: Int64;
    constructor(args?: IMeetingSummarizerParticipantOutputStateArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("MeetingSummarizerParticipantOutputState");
    ...
    public static read(input: thrift.TProtocol): MeetingSummarizerParticipantOutputState {
        ...
        input.readStructEnd();
        return new MeetingSummarizerParticipantOutputState(_args);
    }
}
