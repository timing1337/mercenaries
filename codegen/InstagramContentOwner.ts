...
export interface IInstagramContentOwnerArgs {
    user_id?: string;
    username?: string;
    avatar_url?: string;
}
export class InstagramContentOwner {
    public user_id?: string;
    public username?: string;
    public avatar_url?: string;
    constructor(args?: IInstagramContentOwnerArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("InstagramContentOwner");
    ...
    public static read(input: thrift.TProtocol): InstagramContentOwner {
        ...
        input.readStructEnd();
        return new InstagramContentOwner(_args);
    }
}
