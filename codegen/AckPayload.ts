...
export class AckPayload {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("AckPayload");
    ...
    public static read(input: thrift.TProtocol): AckPayload {
