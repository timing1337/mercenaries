...
export class RenderResolutionMessageToClient {
    ...
    public static read(input: thrift.TProtocol): RenderResolutionMessageToClient {
        ...
        input.readStructEnd();
        return new RenderResolutionMessageToClient(_args);
    }
}
